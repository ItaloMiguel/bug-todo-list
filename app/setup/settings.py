...
SECRET_KEY = str(os.getenv('SECRET_KEY', '!39baca@!_0#debgr!iqq@b&ostj1cv)d$nl812dew=sx9p2a#'))
...
INSTALLED_APPS = [
    ...
    'todousuarios.apps.TodousuariosConfig'
]
...
CSRF_TRUSTED_ORIGINS = ["http://localhost/", "http://todo-list/"]
